...
export default function EditParentPage({
    ...
    const fetchParent = async () => {
      try {
        ...
        toast({
          ...
          description:
            "Er is een fout opgetreden bij het ophalen van de oudergegevens.",
          variant: "destructive",
        });
        router.push("/parents");
      } finally {
  ...
  const validateForm = () => {
    ...
    // Eenvoudige e-mail validatie  errors.push("Telefoonnummer is verplicht")
    ...
    try {
      ...
      if (error.response) {
        ...
        toast({
          title: "Fout bij bijwerken",
          description:
            "Er is een fout opgetreden bij het bijwerken van de ouder.",
          variant: "destructive",
        });
      }
    } finally {
